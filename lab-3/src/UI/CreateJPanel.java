...
public class CreateJPanel extends javax.swing.JPanel {
    ...
    CreateJPanel(Application application) {
       ...
       // this.application = new Application();   application=this.application = new Application();
    }
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 150, 40));

        jLabel2.setText("ID");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 20, 20));
        add(fieldObservationID, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 180, 30));

        jLabel3.setText("Temperature");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 190, 90, 20));
        add(fieldTemperature, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 190, 180, 30));

        jLabel4.setText("Blood Pressure");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 240, 100, 20));
        add(fieldBloodPressure, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 180, 30));
        ...
        add(addObservationbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 330, 180, 40));
